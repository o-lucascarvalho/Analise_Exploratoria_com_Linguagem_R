...
dados_iris <- iris
View(dados_iris)
# Tarefa 1 - Sumarização de dados com as médias de cada coluna do dataset
library(dplyr)
...
# Tarefa 2 - Extração do valor inteiro de uma das colunas decimais
library(data.table)
...
# Tarefa 3 Construção de um gráfico com a relação de duas variáveis numéricas para as 3 categorias de uma variável categórica
library(ggplot2)
